  ...
  return (
    <div className="flex-1 bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white p-8 relative overflow-hidden">
      ...
      <div className="flex justify-between items-center mb-8 relative z-10">
        <div className="bg-gradient-to-r from-gray-800/40 to-gray-700/40 backdrop-blur-sm rounded-2xl p-6 border border-white/30 transition-all duration-300 hover:border-white/40 shadow-[0_0_4px_rgba(255,255,255,0.8),0_30px_100px_rgba(0,0,0,1),0_60px_200px_rgba(0,0,0,0.9),inset_0_1px_0_rgba(255,255,255,0.1)]" style={{
        ...
        <div className="flex items-center space-x-4 bg-gradient-to-r from-gray-800/40 to-gray-700/40 backdrop-blur-sm rounded-2xl p-4 border border-white/30 transition-all duration-300 hover:border-white/40 shadow-[0_0_4px_rgba(255,255,255,0.8),0_30px_100px_rgba(0,0,0,1),0_60px_200px_rgba(0,0,0,0.9),inset_0_1px_0_rgba(255,255,255,0.1)]" style={{
          ...
          <div className="flex items-center space-x-2">
            ...
            <Input
              ...
              className="bg-gray-800/80 border-white/30 text-white backdrop-blur-sm transition-all duration-300 hover:border-white/50 shadow-[0_10px_40px_rgba(0,0,0,0.8)]"
            />
          </div>
          <div className="flex items-center space-x-2">
          ...
          <Button className="bg-gradient-to-r from-cyan-600 to-cyan-500 hover:from-cyan-700 hover:to-cyan-600 transition-all duration-300 transform hover:scale-105 border border-white/20 shadow-[0_15px_60px_rgba(0,0,0,0.9)]">Buscar</Button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 relative z-10">
        ...
        <div className="lg:col-span-2">
          <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-sm rounded-2xl p-6 border border-white/30 transition-all duration-500 hover:border-white/40 relative overflow-hidden shadow-[0_0_8px_rgba(255,255,255,0.8),0_40px_120px_rgba(0,0,0,1),0_80px_250px_rgba(0,0,0,0.95),inset_0_1px_0_rgba(255,255,255,0.1)]" style={{
            animation: 'borderGlow 3s ease-in-out infinite'
          }}>
            {/* Inner glow effect */}
            ...
            <div className="relative z-10">
              ...
              <div className="mt-6 text-center">
                ...
                <div className="flex justify-center space-x-6 mt-4">
                  <div className="flex items-center bg-gray-700/30 rounded-full px-3 py-1 backdrop-blur-sm border border-white/30 shadow-[0_0_4px_rgba(255,255,255,0.8),0_20px_60px_rgba(0,0,0,1),0_40px_120px_rgba(0,0,0,0.9),inset_0_1px_0_rgba(255,255,255,0.1)]" style={{
                    animation: 'borderGlow 3s ease-in-out infinite'
                  }}>
          ...
          <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-sm rounded-2xl p-6 border border-white/30 transition-all duration-500 hover:border-white/40 relative overflow-hidden shadow-[0_0_8px_rgba(255,255,255,0.8),0_40px_120px_rgba(0,0,0,1),0_80px_250px_rgba(0,0,0,0.95),inset_0_1px_0_rgba(255,255,255,0.1)]" style={{
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center bg-gray-700/30 rounded-xl p-4 backdrop-blur-sm border border-white/30 hover:border-white/40 transition-all duration-300 shadow-[0_0_4px_rgba(255,255,255,0.8),0_20px_60px_rgba(0,0,0,1),0_40px_120px_rgba(0,0,0,0.9),inset_0_1px_0_rgba(255,255,255,0.1)]" style={{
                  animation: 'borderGlow 3s ease-in-out infinite'
                }}>
          ...
          <div className="bg-gradient-to-br from-gray-800/60 to-gray-900/60 backdrop-blur-sm rounded-2xl p-6 border border-white/30 transition-all duration-500 hover:border-white/40 relative overflow-hidden shadow-[0_0_8px_rgba(255,255,255,0.8),0_40px_120px_rgba(0,0,0,1),0_80px_250px_rgba(0,0,0,0.95),inset_0_1px_0_rgba(255,255,255,0.1)]" style={{
            ...
            <div className="relative z-10">
              <div className="space-y-4">
                <div className="flex justify-between p-3 bg-gray-700/20 rounded-xl backdrop-blur-sm border border-white/30 hover:border-white/30 transition-all duration-300 shadow-[0_0_4px_rgba(255,255,255,0.8),0_15px_50px_rgba(0,0,0,1),0_30px_100px_rgba(0,0,0,0.9),inset_0_1px_0_rgba(255,255,255,0.1)]" style={{
                  animation: 'borderGlow 3s ease-in-out infinite'
                }}>
              ...
              <Button className="w-full mt-6 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 font-bold transition-all duration-300 transform hover:scale-105 border border-white/20 shadow-[0_25px_80px_rgba(0,0,0,1)]">
                GERAR RELATÓRIO
              </Button>
            </div>
          </div>
